    ...
    <div class="container py-5">
        <header>
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                <a href="/" class="d-flex align-items-center link-body-emphasis text-decoration-none">
                    <span class="fs-4">Google Classroom</span>
                </a>
        ...
        <main>
            <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm @if($plan->featured) border-success @endif ">
                        <div class="card-header py-3 @if($plan->featured) text-white bg-success @endif">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('subscriptions.store') }}" method="post">
                                ...
                                <button type="submit" class="w-100 btn btn-lg btn-outline-success">Subscribe</button>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <div class="text-center pt-2">&copy;googleclassroomclone 2023-2024</div>
    </div>
